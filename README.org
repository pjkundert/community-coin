...
* Proposed Transition
  ...
  amongst their community using [[https://slip39.com][SLIP-39]] [fn:SLIP-39: A method for reliably and securely splitting
  seed entropy (such as BIP-39 mnemonic phrases) between many parties.] backups, and performing
  on-chain (L1; Bitcoin, Ethereum), side-chain (L2; Lightning) and non-custodial exchange
...
**** Crypto Wallet Setup, Security & Reliability
     ...
     to much more reliable and powerful systems built on Holochain[fn:Holochain: A development
     platform for large-scale decentralized and distributed systems, which yields many of the
     benefits of "blockchain" while avoiding some of their intractable problems, provides
...
*** Convertability
    ...
    used to for Fiat on/off-ramps.  Many exchanges deal in Ethereum and ERC-20[fn:ERC-20: The
    standard for defining and creating fungible tokens such as cryptocurrencies on the
    Ethereum Virtual Machine.] Stablecoins such as USDC and USDT, so a means must be available to
    convert between the native Community Currency units and an ERC-20[fn:ERC-20] form.
